...
def get_errors_over_time(errors_df: pd.DataFrame, output_file: str = "errors_over_time.xlsx") -> pd.DataFrame:
...
def analyze_balance_sync(transactions_df, errors_df) -> pd.DataFrame:
...
def get_top_error_reasons(errors_df: pd.DataFrame, transactions_df: pd.DataFrame, output_file: str = "top_error_reasons_pie.xlsx") -> pd.DataFrame:
...
def get_total_loss_by_currency(errors_df: pd.DataFrame, output_file: str = "loss_by_currency.xlsx") -> pd.DataFrame:
